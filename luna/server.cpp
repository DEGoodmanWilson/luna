...
server::response_handler_handle server::handle_request(request_method method, std::regex &&path, endpoint_handler_cb callback)
{
    return impl_->handle_request(method, std::regex{std::move(path)}, callback);
}

server::response_handler_handle server::handle_request(request_method method, const std::regex &path, endpoint_handler_cb callback)
{
    return impl_->handle_request(method, std::regex{path}, callback);
}

void server::remove_request_handler(server::response_handler_handle item)
{
